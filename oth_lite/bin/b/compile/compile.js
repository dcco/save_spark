define(["require", "exports"], function (require, exports) {
    ...
    exports.compBody = exports.compStmt = void 0;
    function compPrim(f, el) {
        switch (f) {
            case 'add':
            case 'concat':
    ...
    function compStmt(s) {
        switch (s.stmt) {
            ...
            case 'cond':
                var brCode = "";
                for (var i = 0; i < s.brList.length; i++) {
                    var br = s.brList[i];
                    if (i !== 0)
                        brCode = brCode + " else ";
    ...
    exports.compStmt = compStmt;
    function compBody(sl) {
        var bodyCode = "";
