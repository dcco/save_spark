...
declare namespace WebGL2RenderingContextStrict {
	...
	interface Base extends Constants {
		...
		texImage2D(target: GL.TexImage2DTarget, level: GLint, internalformat: GL2['DEPTH_COMPONENT32F'], width: GLsizei, height: GLsizei, border: 0, format: GL2['DEPTH_COMPONENT'], type: GL2['HALF_FLOAT'] | GL2['FLOAT'], pixels: Float32Array | null): void;
		//#endregion
